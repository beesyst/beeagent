...
_LABELS_EN: dict[str, str] = {
    ...
    "Username": "Username",
    "Password": "Password",
    "Provide the mailbox username and password.": "Provide the mailbox username and password.",
    "Authority": "Authority",
    "Read Only": "Read only",
    "Draft Only": "Draft only",
    "Execution Capable": "Execution capable",
    "ROP sources": "ROP sources",
    "Configured ROP sources and their current processing status.": "Configured ROP sources and their current processing status.",
    "Not run": "Not run",
    "Disabled": "Disabled",
    "Delete": "Delete",
    ...
    "Contributing sources": "Contributing sources",
    "Available sources": "Available sources",
    "Last checked state": "Last checked state",
    "Check connection": "Check connection",
    "Source available. Check again": "Source available. Check again",
    "Credentials are not configured. Check again": "Credentials are not configured. Check again",
    "Authentication failed. Check again": "Authentication failed. Check again",
    "Source unavailable. Check again": "Source unavailable. Check again",
    "Bitrix": "Bitrix",
...
_LABELS_RU: dict[str, str] = {
    ...
    "Password": "Пароль",
    "Provide the mailbox username and password.": "Укажите имя пользователя и пароль почтового ящика.",
    "Host": "Host",
    "Folder": "Папка",
    "Enabled": "Включён",
    "Authority": "Доступ",
    "Read Only": "Только чтение",
    "Draft Only": "Только черновики",
    "Execution Capable": "Разрешено выполнение",
    "ROP sources": "Источники РОПа",
    "Configured ROP sources and their current processing status.": "Настроенные источники РОПа и их текущее состояние обработки.",
    ...
    "Sources": "Источники",
    "Processed total": "Обработано всего",
    "Contributing sources": "Источники с данными",
    "Available sources": "Доступные источники",
    "Last checked state": "По последней проверке",
    "Check connection": "Проверить подключение",
    "Source available. Check again": "Источник доступен. Проверить снова",
    "Credentials are not configured. Check again": "Не заданы учётные данные. Проверить снова",
    "Authentication failed. Check again": "Ошибка авторизации. Проверить снова",
    "Source unavailable. Check again": "Источник недоступен. Проверить снова",
